        ...
        <div className="h-[64px] flex flex-row items-center justify-between border rounded-full">
            <div>
                <div className="flex flex-row items-center justify-between">
                    ...
                    <div className=" h-[64px] px-8 flex justify-center flex-col rounded-full hover:bg-gray-100">
            ...
            <div className="p-2">
                <div className="p-4 bg-airbnb hover:bg-airbnb-dark transition rounded-full text-white">
